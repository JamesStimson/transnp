...
> Filter record on specified logical matrix, which specifies who can infect who. Record entries are kept only where infection events correspond to a TRUE entry in the testMatrix. 
