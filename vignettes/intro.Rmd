...
```{r}
aligns <- list()
aligns <- addAlignment(aligns, "test_cluster_CL001.fas")
aligns <- addAlignment(aligns, "test_cluster_CL002.fas")
aligns <- addAlignment(aligns, "test_cluster_CL005.fas")
aligns <- addAlignment(aligns, "test_cluster_CL007.fas")
```
...
allDates <- read.csv(system.file("extdata", "test_dates.csv", package = "transnp", mustWork = TRUE))
